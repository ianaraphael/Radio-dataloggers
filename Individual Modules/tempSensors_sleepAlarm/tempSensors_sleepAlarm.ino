...
tempSensors_sleepAlarm.ino

Temperature sensor station with deep sleep and alarm functionality. Samples
temperature sensors and saves to a file on SD card. Enters standby (low power)
mode. Wakes up by scheduled RTC alarm interrupt.
